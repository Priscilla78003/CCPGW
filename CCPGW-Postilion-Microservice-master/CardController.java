...
public class CardController {
    ...
    @PostMapping("transaction/detail/write")
    @CrossOrigin(origins = "*")
    public void transactionDetailWrite(@RequestBody TransactionDetails transaction) {
        Object[] parameters = {
            transaction.getThreeDSServerTransID(),
            transaction.getOrder_id(),
            transaction.getTransaction_id(),
            transaction.getSecretKey(),
        ...
        databaseDao.insert("ccpgw.transaction.manager.write.transaction.detail", parameters, paramterTypes);        
    }

    @PostMapping("transaction/detail/read")
    @CrossOrigin(origins = "*")
    public String transactionDetailRead(@RequestBody TransactionDetails transaction) {
        TransactionDetails transactionOut = (TransactionDetails) databaseDao.findByName("ccpgw.transaction.manager.read.transaction.detail", TransactionDetails.class, transaction.getThreeDSServerTransID());
        return toJSON(transactionOut);
    }    
