 ...
 */
public class runPostilionAdapterFinancialTransaction {
    
    private static final LogWrapper mLogger = new LogWrapper(runPostilionAdapterAuth.class);
    ...
    public static void main(String[] args) throws ServiceException, MessageException, ISOException {  
        ...
        AuthoriseObject authObj = new AuthoriseObject(  eAuth.FINANCIAL,
                                                        "",
