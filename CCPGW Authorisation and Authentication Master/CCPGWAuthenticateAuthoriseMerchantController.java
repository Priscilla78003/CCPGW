...
/**
    ...
    * 2022-08-03
     */
    @PostMapping("/keycloak/authenticate/authorise/merchant/read/details")
    @CrossOrigin(origins = "*")
    public String GetMerchantDetails(HttpServletRequest request,
            HttpServletResponse response,
            @RequestBody AuthResult userAuthObj) throws IOException, Exception {
    ...
    * 2022-08-03
     */
    @PostMapping("/keycloak/authenticate/authorise/merchant/refund")
    @CrossOrigin(origins = "*")
    public String ProcessMerchantRefund(HttpServletRequest request,
            HttpServletResponse response,
            @RequestBody EncryptionSession encryptedSession) throws IOException, Exception {

        return ValidateAndCallMicroService(request,
                response,
                encryptedSession.getUsername(),
                encryptedSession.getSessionkey(),
                "/postilion/refund",
                encryptedSession.toJSON());
