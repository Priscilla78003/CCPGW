...
public class ThreeDSV2controller {
    ...
    @CrossOrigin(origins = "*")
    public ThreeDSServerVersioningV3Response Versioning (@RequestBody ThreeDSV2ServerVersioningRequest versionReq) {
       ...
       String keystorepassword = "";
        ...
        Gson gson = new Gson();
        //----------------------------------------------------------------------
        //This code was added in for the Versioning V3
        ...
        Collection<ThreeDSServerVersioningV3Response> versionV3Response = gson.fromJson(result.getData(), collectionType);

        Object[] obj = versionV3Response.toArray();
        ThreeDSServerVersioningV3Response versionResponse= (ThreeDSServerVersioningV3Response)obj[0];
        //----------------------------------------------------------------------
