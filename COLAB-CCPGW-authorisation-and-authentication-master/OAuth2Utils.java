...
public class OAuth2Utils implements IOAuth2Constants {
    ...
    public Map<String, String> getAccessToken(OAuth2Parameters oath2Parameters) throws IOException {
        ...
        mLogger.debug("grant_type: "+oath2Parameters.getGrantType());
        mLogger.debug("username: "+ oath2Parameters.getUsername());
        mLogger.debug("password: "+oath2Parameters.getPassword());
        mLogger.debug("client_id: "+ oath2Parameters.getClient_id());
        mLogger.debug("client_secret: "+ oath2Parameters.getClient_secret());
        mLogger.debug("scope: "+ oath2Parameters.getScope());
        
        System.out.println("grant_type: "+oath2Parameters.getGrantType());
        System.out.println("username: "+ oath2Parameters.getUsername());
        System.out.println("password: "+oath2Parameters.getPassword());
        System.out.println("client_id: "+ oath2Parameters.getClient_id());
        System.out.println("client_secret: "+ oath2Parameters.getClient_secret());
        System.out.println("scope: "+ oath2Parameters.getScope());        
