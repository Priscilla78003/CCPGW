...
//        }
     ...
     * ========================================================================= 
     */
    private ThreeDSServerVersioningResponse process3DSv2xVersioningRequest(String cardholderAccountNumber, String scheme){
     ...
     * ========================================================================= 
     */
    private void persistEnrolled(ThreeDSServerVersioningResponse threeDSServerVersioning,
                                 PaymentDetailType paymentType, 
                                 String scheme){
     ...
     * ========================================================================= 
     */
    private void persist3DSv2xAuthenticationRequest(ThreeDSServerVersioningResponse threeDSServerVersioning,
                                                      PaymentDetailType paymentType, 
                                                      String scheme,
        ...
        authReq.setThreeDSRequestorURL(threeDSServerVersioning.getThreeDSMethodURL());
     ...
     * =========================================================================
     */
    public AuthRSObject process3DSStepOneVersion2x(String orderNumber, String transactionId, PaymentDetailType paymentType) {
        ...
        ThreeDSServerVersioningResponse versionRes = process3DSv2xVersioningRequest(paymentType.getPaymentCard().getCardNumber(), scheme);    
        ...
        if (versionRes.getThreeDSMethodDataForm() != null){
         ...
         threeDSMethodData  = map.get("threeDSMethodData");
             ...
             String stringToEncode = "{\"threeDSServerTransID\":\""+versionRes.getThreeDSServerTransID()+"\",\"threeDSMethodNotificationURL\":\"https://ccpgw.testbsp.com.pg/3dsmethodnotification\"}";
        ...
        AuthRS.T3DSResult t3ds = new AuthRS.T3DSResult();
        getmLogger().info("Setting IssuerURL to: https://ccpgw.testbsp.com.pg/3dsredirectmechanism");
        t3ds.setIssuerURL("https://ccpgw.testbsp.com.pg/3dsredirectmechanism");
        ...
        this.PersistACS(new AcsPareqElement("https://ccpgw.testbsp.com.pg/3dsredirectmechanism",threeDSMethodData));
    ...
    private AuthoriseResponse ThreeDS2xTransaction(ThreeDSServerResultsResponse threeDSServerResultsResponse, PaymentDetailType paymentType) {
        ...
        String structuredData = constructStructuredDataDE127_22("2",
                                                                threeDSServerResultsResponse.getResultsRequest().getAuthenticationMethod(),
