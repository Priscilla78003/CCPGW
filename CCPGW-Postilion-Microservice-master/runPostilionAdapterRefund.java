 ...
 */
public class runPostilionAdapterRefund {
    private static final LogWrapper mLogger = new LogWrapper(runPostilionAdapterRefund.class);
    ...
    public static void main(String[] args) throws ServiceException, MessageException, ISOException {  
        ...
        AuthoriseObject authObj = new AuthoriseObject(  eAuth.REFUND,
                                                        "",
